const {
  ...
  const ownerNumber = ['923163954173']
...
const sessdata = config.SESSION_ID.replace("Muqeet~", '');
...
const port = process.env.PORT || 9090;
  ...
  let up = `*✨ ℍ𝕖𝕝𝕝𝕠, 𝕄𝕌ℚ𝔼𝔼𝕋-𝕏𝕄𝔻 𝗨𝗦𝗘𝗥! ✨*

╭─〔 *🤖 𝐌𝐔𝐐𝐄𝐄𝐓-𝐗𝐌𝐃 * 〕 
├─▸ *𝐒𝐩𝐞𝐞𝐝. 𝐏𝐨𝐰𝐞𝐫. 𝐁𝐘 𝑴𝑼𝑸𝑬𝑬𝑻 |* 
╰─➤ *𝐘𝐨𝐮𝐫 𝐍𝐞𝐰 𝐖𝐡𝐚𝐭𝐬𝐀𝐩𝐩 𝐁𝐎𝐓 𝐢𝐬 𝐇𝐞𝐫𝐞!*

*❤️ 𝐓𝐡𝐚𝐧𝐤 𝐲𝐨𝐮 𝐟𝐨𝐫 𝐂𝐡𝐨𝐨𝐬𝐢𝐧𝐠 𝐌𝐔𝐐𝐄𝐄𝐓-𝐗𝐌𝐃!*

╭──〔 🔗 *𝐐𝐮𝐢𝐜𝐤 𝐋𝐢𝐧𝐤𝐬* 〕 
├─ 📢 *𝐉𝐨𝐢𝐧 𝐎𝐮𝐫 𝐂𝐡𝐚𝐧𝐧𝐞𝐥:* 
│ 𝐂𝐥𝐢𝐜𝐤 [**𝐇𝐞𝐫𝐞**](https://whatsapp.com/channel/0029VbAqZNoDDmFSGN0sgx3L) 𝐭𝐨 𝐣𝐨𝐢𝐧! 
├─ ⭐ *𝐆𝐢𝐯𝐞 𝐔𝐬 𝐚 𝐒𝐭𝐚𝐫:* 
│ 𝐒𝐭𝐚𝐫 𝐔𝐬 [**𝐇𝐞𝐫𝐞**](https://github.com/muqeet908/MUQEET-XMD)!
╰─🛠️ *Prefix:* \`${prefix}\`

> _© 𝐃𝚵𝛁𝚵𝐋𝚯𝚸𝚵𝚪 𝕄𝕌ℚ𝔼𝔼𝕋_`;
    conn.sendMessage(conn.user.id, { image: { url: `https://files.catbox.moe/q7ykfx.jpg` }, caption: up })
  }
  })
 ...
 //================ownerreact==============
  ...
  if(senderNumber.includes("923163954173")){
  if(isReact) return
  m.react("💙")
   }
  //==========public react============//
